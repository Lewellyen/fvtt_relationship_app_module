<#
.SYNOPSIS
Phase 3: Migriert Application Layer Token-Imports zu spezifischen Dateien

.DESCRIPTION
Migriert automatisch die Token-Imports in Application Layer-Dateien:
...
# Token-zu-Datei Mapping (gleich wie Phase 1 & 2)
$tokenMapping = @{
    # Core tokens
...
Write-Host "Phase 3: Application Layer Migration" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host ""

# Target-Verzeichnisse für Phase 3
$targetDirs = @(
...
Write-Host ""
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "Zusammenfassung Phase 3:" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Phase 3 erfolgreich abgeschlossen!" -ForegroundColor Green
    Write-Host "=====================================" -ForegroundColor Green
    Write-Host "Naechster Schritt: Commit und Phase 4" -ForegroundColor Gray
} else {
    Write-Host ""
    Write-Host "=====================================" -ForegroundColor Red
    Write-Host "Type-Check fehlgeschlagen!" -ForegroundColor Red
    Write-Host "=====================================" -ForegroundColor Red
    Write-Host "Rollback: git checkout src/application" -ForegroundColor Yellow
    exit 1
}
