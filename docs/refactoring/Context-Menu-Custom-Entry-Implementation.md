...
- [ ] `FoundryJournalEventAdapter.onJournalContextMenu()` umgeschrieben
- [ ] libWrapper-Integration implementiert (einmalige Registrierung für alle Callbacks)
- [ ] Callback-Management (Array von Callbacks, Cleanup bei unregister)
- [ ] Tests angepasst (libWrapper mocken)

### Application Layer (Handler-Pattern)
- [ ] `JournalContextMenuHandler` Interface definiert
- [ ] `HideJournalContextMenuHandler` implementiert
- [ ] `RegisterContextMenuUseCase` als Orchestrator (Handler-Array)
- [ ] Use-Case Token aktualisiert (`registerContextMenuUseCaseToken`)
- [ ] Handler-Token registriert (für DI)

### Cleanup
- [ ] `RegisterJournalContextMenuUseCase` entfernt (alte Implementierung)
- [ ] Alte Token entfernt/umbenannt

### Testing
- [ ] `FoundryJournalEventAdapter` Tests (libWrapper-Integration)
- [ ] `RegisterContextMenuUseCase` Tests (Event-Port mocken)
- [ ] Integration-Tests (MenuItem erscheint, Callback funktioniert)

### Funktionalität
- [ ] lib-wrapper als Dependency in module.json
- [ ] MenuItem "Journal ausblenden" erscheint im Context-Menü
- [ ] MenuItem wird nicht angezeigt, wenn Journal bereits versteckt ist
- [ ] Callback funktioniert (Journal wird versteckt)
- [ ] Notification wird angezeigt

### Dokumentation
- [ ] CHANGELOG.md aktualisiert
- [ ] ARCHITECTURE.md aktualisiert (Event-Port-Pattern dokumentieren)
