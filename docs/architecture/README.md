...
**Zweck:** Architektur-Dokumentation des Moduls
...
- [Architektur-Übersicht](./overview.md) - High-Level Architektur ⭐ **Start hier**
...
- [Token-Katalog](../reference/tokens.md) - DI-Token-Übersicht (TODO)
- [Service-Übersicht](../reference/services.md) - Service-Dokumentation

---

**Siehe auch:** [Hauptindex](../README.md)
