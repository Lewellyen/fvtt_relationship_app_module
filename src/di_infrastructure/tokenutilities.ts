// TokenUtilities.ts: Utility function to create type-safe injection tokens
 ...
 */
export function createInjectionToken<TServiceType extends ServiceType>(description: string): InjectionToken<TServiceType> {
