...
import { MODULE_METADATA, JOURNAL_PAGE_SHEET_TYPE } from "@/application/constants/app-constants";
...
/**
 * Foundry adapter for registering JournalEntryPage sheets and data models.
 */
export class FoundryJournalEntryPageSheetRegistrationAdapter implements PlatformJournalEntryPageSheetRegistrationPort {
...
export class DIFoundryJournalEntryPageSheetRegistrationAdapter extends FoundryJournalEntryPageSheetRegistrationAdapter {
